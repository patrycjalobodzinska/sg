  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: "readStory", title: "Read full story link", type: "internationalizedArrayString" }),
        defineField({ name: "readMore", title: "Read more link", type: "internationalizedArrayString" }),
